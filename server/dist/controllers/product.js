...
exports.getAllProductsWithFilter = exports.getSingleProduct = exports.getAllCategories = exports.getProductByStatus = exports.getAllProducts = void 0;
const error_1 = require("../middleware/error");
const axios_1 = __importDefault(require("axios"));
const productsUrl = "https://s3.us-east-1.amazonaws.com/assets.spotandtango/products.json";
...
exports.getProductByStatus = (0, error_1.TryCatch)(async (req, res, next) => {
    const { status } = req.params;
    const products = await fetchAllProducts();
    const availableProducts = products.filter((product) => product.status.toLowerCase() ===
        status.toLowerCase());
    res.status(200).json(availableProducts);
});
exports.getAllCategories = (0, error_1.TryCatch)(async (req, res) => {
    const products = await fetchAllProducts();
    const categories = Array.from(new Set(products.map((product) => product.group)));
...
exports.getAllProductsWithFilter = (0, error_1.TryCatch)(async (req, res, next) => {
